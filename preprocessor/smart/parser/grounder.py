...
class Grounder(object):
    ...
    def write_asp(self):
        ...
        """
        if not os.path.exists(os.path.dirname(self.pre_file_name)) :
            os.makedirs( os.path.dirname(self.pre_file_name) )
        print("ASP for grounding: {}".format(self.pre_file_name))
