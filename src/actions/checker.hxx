...
public:
	...
	static bool check_correctness(const Problem& problem, const std::vector<GroundAction>& plan, const State& s0);
	...
	static void print_plan_execution(const Problem& problem, const std::vector<GroundAction>& plan, const State& s0);
