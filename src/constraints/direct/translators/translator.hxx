...
protected:
	...
	static DirectConstraint* instantiateUnaryConstraint(fs::RelationalFormula::Symbol symbol, const VariableIdxVector& scope, const std::vector<ObjectIdx>& parameters, bool invert);

	//! Helper to instantiate binary constraints
	static DirectConstraint* instantiateBinaryConstraint(fs::RelationalFormula::Symbol symbol, const VariableIdxVector& scope, const std::vector<ObjectIdx>& parameters);
