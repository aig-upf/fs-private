...
AtomMinHMaxValueSelector::AtomMinHMaxValueSelector(const GecodeCSPVariableTranslator* translator, const RPGData* bookkeeping)
	: _translator(translator), _bookkeeping(bookkeeping)
{}

int AtomMinHMaxValueSelector::select(const Gecode::IntVar& x, unsigned csp_var_idx) const {
