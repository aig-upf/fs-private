...
namespace fs0 {
  ...
  namespace gecode {
    ...
    void
    UnaryDomainBoundsConstraintTranslator::addConstraint(ScopedConstraint::cptr c, ActionCSP& csp ) const {
    ...
    void
    BinaryDomainBoundsConstraintTranslator::addConstraint( ScopedConstraint::cptr c, ActionCSP& csp ) const {
