...
public:
	...
	//! The translator can optionally register any number of CSP variables.
	virtual void registerVariables(SimpleCSP& csp, GecodeCSPTranslator& translator, ScopedConstraint::cptr constraint, Gecode::IntVarArgs& variables) const {}
	
	//! The translator can register any number of CSP constraints
	virtual void registerConstraints(SimpleCSP& csp, const GecodeCSPTranslator& translator, ScopedConstraint::cptr constraint) const = 0;
};
...
public:
	...
	//! The translator can optionally register any number of CSP variables.
	virtual void registerVariables(SimpleCSP& csp, GecodeCSPTranslator& translator, ScopedEffect::cptr effect, Gecode::IntVarArgs& variables) const {}
	
	//! The translator can register any number of CSP constraints
	virtual void registerConstraints(SimpleCSP& csp, const GecodeCSPTranslator& translator, ScopedEffect::cptr effect) const = 0;
};


class ExtensionalUnaryConstraintTranslator : public ConstraintTranslator  {
public:
	void registerConstraints(SimpleCSP& csp, const GecodeCSPTranslator& translator, ScopedConstraint::cptr constraint) const;
};
...
public:
	...
	virtual void registerConstraints(SimpleCSP& csp, const GecodeCSPTranslator& translator, ScopedConstraint::cptr constraint) const;
};
...
public:
	void registerConstraints(SimpleCSP& csp, const GecodeCSPTranslator& translator, ScopedEffect::cptr constraint) const;
};
