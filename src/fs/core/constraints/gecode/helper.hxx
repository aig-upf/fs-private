...
public:
	...
	static void constrainCSPVariable(FSGecodeSpace& csp, const Gecode::IntVar& variable, const Gecode::IntSet& domain);
	...
	static void postBranchingStrategy(FSGecodeSpace& csp);
