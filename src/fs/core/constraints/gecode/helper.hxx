...
public:
	...
	static void constrainCSPVariable(GecodeSpace& csp, const Gecode::IntVar& variable, const Gecode::IntSet& domain);
	...
	static void postBranchingStrategy(GecodeSpace& csp);
